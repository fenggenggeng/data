        ...
        children: [
            {
                path: 'index',
                title: '接入管理系统',
                name: 'access_system_index',
                component: () => import('@/views/access-system/access-system.vue')
            }
        ]
    ...
    },
    {
        ...
        children: [
...

            {
                ...
                title: '资源列表',
                name: 'resource_list',
                component: () => import('@/views/resource/find/list.vue'),
            ...
            },
            {
                ...
                title: '资源树列表',
                name: 'list_tree',
                component: () => import('@/views/resource/find/list/tree.vue')
            },
        ]
