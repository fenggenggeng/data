...
<template>
    <Menu ref="sideMenu" :active-name="openNames[0]" :open-names="openNames" :theme="menuTheme" width="auto" @on-select="menuSelect">
        ...
        <!--<Submenu name="1">-->
            ...
            <!--<MenuItem name="1-1" ><router-link tag="li" to="/organization-management-system">组织机构管理</router-link></MenuItem>-->
             <!--<MenuItem name="1-2" ><router-link tag="li" to="/component/access-management-system">接入管理系统</router-link></MenuItem>-->
              <!--<MenuItem name="1-3" ><router-link tag="li" to="/component/authorization-role">授权资源管理</router-link></MenuItem>-->
        ...
        <Submenu name="2">
            ...
            <MenuItem name="2-4"><router-link  tag="li" to="/component/task-table">任务记录</router-link></MenuItem>
            <MenuItem name="2-5"><router-link  tag="li" to="/component/spark-table">SPARK工作台</router-link></MenuItem>
            <MenuItem name="2-6"><router-link  tag="li" to="/component/hue-table">HUE工作台</router-link></MenuItem>
            <MenuItem name="2-7"><router-link  tag="li" to="/component/data_com">元数据对比</router-link></MenuItem>
        </Submenu>
           <Submenu name="3">
            <template slot="title">
