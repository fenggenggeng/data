...
export default {
            ...
            return row("Checkbox", {
              ...
              on: {
                "on-change": (event, data) => {
                    this.historyData[column.index].selectStatus =column.row.selectStatus == 1 ? 0 : 1;
                    column.row.selectStatus =column.row.selectStatus == 1 ? 0 : 1;
        ...
        },
        {
          ...
          render: (row, column, index) => {
            ...
            return row("Checkbox", {
              ...
              on: {
                "on-change": (event, data) => {
                    this.historyData[column.index].insertStatus =column.row.insertStatus == 1 ? 0 : 1;
                     column.row.insertStatus =column.row.insertStatus == 1 ? 0 : 1;
        ...
        },
        {
          ...
          render: (row, column, index) => {
            ...
            return row("Checkbox", {
              ...
              on: {
                "on-change": (event, data) => {
                    this.historyData[column.index].updateStatus =column.row.updateStatus == 1 ? 0 : 1;
                    column.row.updateStatus =column.row.updateStatus == 1 ? 0 : 1;
        ...
        },
        {
          ...
          render: (row, column, index) => {
            ...
            return row("Checkbox", {
              ...
              on: {
                "on-change": (event, data) => {
                    this.historyData[column.index].deletetStatus =column.row.deletetStatus == 1 ? 0 : 1;
                    column.row.deletetStatus =column.row.deletetStatus == 1 ? 0 : 1;
                }
              }
            });
          }
  ...
  methods: {
    ...
    submit() {
      this.SpinType=true;
      let isType=["deletetStatus","insertStatus","selectStatus","updateStatus"];
      let params = [];
       this.historyData.map((item,index)=>{
            let data = [];
        for (let info in item) {
          if (this.historyOldData[index][info]!=item[info] && isType.indexOf(info)>-1) {
            data.push({
                  dbName: item.dbName,
